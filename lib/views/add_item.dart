  ...
  Widget imageRender(BuildContext context, String imageUrl, bool isChosen) {
    return Container(
      ...
      decoration: BoxDecoration(
          border: Border.all(
              color: isChosen ? Colors.blue : Colors.white, width: 1.0)),
            ...
            children: <Widget>[
              ...
              Container(
                ...
                child: Row(
                  ...
                  children: <Widget>[
                    imageRender(
                        context, imageUrl[0], imageUrlAndChosen[imageUrl[0]]),
                    imageRender(
                        context, imageUrl[1], imageUrlAndChosen[imageUrl[1]]),
                    imageRender(
                        context, imageUrl[2], imageUrlAndChosen[imageUrl[2]]),
                    imageRender(
                        context, imageUrl[3], imageUrlAndChosen[imageUrl[3]]),
                  ],
                ),
              ),
              Container(
                ...
                child: Row(
                  ...
                  children: <Widget>[
                    imageRender(
                        context, imageUrl[4], imageUrlAndChosen[imageUrl[4]]),
                    imageRender(
                        context, imageUrl[5], imageUrlAndChosen[imageUrl[5]]),
                    imageRender(
                        context, imageUrl[6], imageUrlAndChosen[imageUrl[6]]),
                    imageRender(
                        context, imageUrl[7], imageUrlAndChosen[imageUrl[7]]),
                  ],
                ),
              ),
              FlatButton(
